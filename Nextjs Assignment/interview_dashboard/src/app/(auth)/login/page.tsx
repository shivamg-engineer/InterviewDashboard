    ...
    return (
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-teal-800/20 mb-4">
        ...
        <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 bg-white/5 border-white/10 space-y-5" noValidate>
          {error && (
            <div className="bg-destructive/10 border border-destructive/30 text-destructive rounded-lg px-4 py-3 text-sm" role="alert">
              {error}
            </div>
          )}
